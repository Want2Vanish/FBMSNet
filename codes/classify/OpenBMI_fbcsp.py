...
class LoadKU(LoadData):
    ...
    def get_epochs(self,dataPath, url = None, epochWindow = [0,4],
...
class MLEngine:
    ...
    def experiment(self):
        ...
        '''for BCIC Dataset'''
        datasetPath = 'D:/Projects/Pycharm/helloPycharm/FBCNet-master/data/korea/originalData'
        ...
        for i in range(len(subjects)):
            train_set = ku_data.get_epochs(os.path.join(datasetPath, 'session1','s'+str(i+1), 'EEG_MI.mat'))
            test_set = ku_data.get_epochs(os.path.join(datasetPath, 'session2','s'+str(i+1), 'EEG_MI.mat'))
...
if __name__ == "__main__":
    ...
    # [0.665, 0.7, 0.92, 0.475, 0.68, 0.715, 0.6, 0.525, 0.475, 0.575, 0.52, 0.59, 0.62, 0.535, 0.505, 0.53, 0.515, 0.74,
    #  0.715, 0.505, 0.915, 0.56, 0.6, 0.555, 0.555, 0.58, 0.475, 0.93, 0.975, 0.635, 0.58, 0.715, 0.835, 0.47, 0.475,
    #  0.98, 0.885, 0.5, 0.585, 0.52, 0.545, 0.56, 0.67, 0.945, 0.75, 0.555, 0.49, 0.465, 0.535, 0.59, 0.51, 0.63, 0.57,
    #  0.455]